 ...
 * @Last Modified time: 2018-06-22 10:02:52
 *
 * 退货单列表搜索
 */
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <SearchItem {...labelCol} label="服务类型" simple>
          {
            ({ form }) => (
        ...
        <SearchItem {...labelCol} label="是否有实物退货" simple>
          {
            ({ form }) => (
              form.getFieldDecorator('isHasEntity', {
              })(
                this.getSearchOptionsElm(returnOfGoodsTypeOptions, false)
              )
            )
          }
        </SearchItem>
