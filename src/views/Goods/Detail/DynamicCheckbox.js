...
import { Form, Checkbox, Icon, Button, Input, message } from 'antd';
import _ from 'lodash';
import './DynamicCheckbox.less';

export default class DynamicCheckbox extends Component {
  state = {
    lastFilters: [],
    filters: [],
  }
  ...
  render() {
    const { form, label, value, required, custom, filedId, disabled } = this.props;
    const { filters } = this.state;
