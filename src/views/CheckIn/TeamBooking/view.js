...
import { teamBookingStatus, QUERY_STATE, RES_TYPE, GRES_TYPE, BATCH } from '../common/status';
    ...
    return (
      <PageHeaderLayout>
        <Card>
          <h2>
            <span>团队预订及登记</span>
            <Authorized authority={[permission.PMS_CHECKIN_GROUPRESERVATION_GROUPRESERVE]}>
              <Button type="gray" style={{ float: 'right' }} href="#/checkin/teambooking/add">+ 团队预订</Button>
            </Authorized>
          </h2>
          <Divider />
          <PanelList>
            ...
            <Batch>
              <Radio.Group value={this.state.selectedRadio} buttonStyle="solid" onChange={this.handleBatchChange.bind(this)}>
                ...
                <Radio.Button value={QUERY_STATE.TodayIn.value}>今日已到</Radio.Button>
                ...
                <Radio.Button value={QUERY_STATE.All.value}>所有团队预订及登记</Radio.Button>
              </Radio.Group>
            </Batch>
